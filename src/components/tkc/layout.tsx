    ...
    <section className='-mx-4 -mt-20 overflow-hidden md:-mx-6 md:-mt-24'>
      <div className='relative h-[320px] sm:h-[380px] md:h-[520px] lg:h-[560px]'>
        ...
        <div className='absolute inset-x-0 bottom-0 px-6 pb-8 sm:px-10 sm:pb-10 md:pb-14'>
          <FadeIn>
            <div
              className='mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-black/40 px-4 py-[7px] font-mono text-[12px] font-semibold tracking-[1.5px] backdrop-blur-md'
          ...
          <FadeIn delay={120}>
            <h1 className='text-[clamp(30px,8.5vw,56px)] leading-[1.1] font-extrabold tracking-tight drop-shadow-[0_2px_16px_rgba(0,0,0,0.9)]'>
              <span
          ...
          {subtitle && (
            <FadeIn delay={240}>
              <p className='mt-4 max-w-[520px] text-[14px] leading-[1.55] font-light break-keep text-white/70 [text-shadow:0_1px_8px_rgba(0,0,0,0.7)] sm:text-[15px]'>
                {subtitle}
              </p>
            </FadeIn>
          )}
