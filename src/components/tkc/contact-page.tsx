      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <FaqList
              items={['1차수: 서울 / 2차수: 대전 / 3차수: 광주 / 4차수: 부산']}
            />
            <FaqNote>
      ...
      },
      {
        ...
        answer: (
          <>
            과제곡 2곡의 점수를 합산하여 순위를 산정합니다.
            <FaqList
              items={['もものけ姫 앞보면 8레벨', '輝く未来を 귀신 8레벨']}
            />
            <FaqNote>각 차수별 상위 16명이 오프라인 예선에 진출합니다.</FaqNote>
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            ...
            최대 4라운드까지 진행되며, 4-0 기록자는 자동 결선 진출, 3-1 기록자
            중 추가 선발을 통해 1명이 추가 진출합니다.
          </>
        ),
      },
      {
    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            시드로 배치합니다.
            <FaqList items={['A1 vs B4 / A2 vs B3 / A3 vs B2 / A4 vs B1']} />
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            ...
            <strong className='text-white/90'>밴빙한 곡은 소모되지 않아</strong>{' '}
            다음 라운드에서 재사용 가능합니다.
          </>
        ),
      },
    ...
    items: [
      {
        ...
        answer: (
          <>
            예선에서는 공정성 확보를 위해{' '}
            <strong className='text-white/90'>모든 옵션 사용이 금지</strong>
...
function FaqNote({ children }: { children: ReactNode }) {
  return (
    <div className='mt-2.5 flex items-center gap-2 rounded-xl border border-[#f5a623]/[0.12] bg-[#f5a623]/[0.04] p-2.5 text-[12px] leading-[1.55] text-white/50 sm:text-[13px]'>
            ...
            return (
              <div key={sIdx} className='space-y-3'>
                ...
                <div className='flex items-center gap-2.5 border-b border-[#1e1e1e] pb-3'>
                  ...
                  {section.tag && (
                    <span className='rounded bg-[#f5a623]/[0.08] px-2.5 py-0.5 font-mono text-[12px] font-bold tracking-wide text-[#f5a623]'>
          ...
          <table className='w-full text-[13px]'>
            ...
            <thead>
              <tr className='border-b border-[#1e1e1e] bg-[#1a1a1a]'>
                <th className='px-5 py-3.5 text-left font-mono text-[12px] font-semibold tracking-wide text-white/35 uppercase'>
                  항목
                </th>
                <th className='px-5 py-3.5 text-left font-mono text-[12px] font-semibold tracking-wide text-[#f5a623] uppercase'>
                  콘솔
                </th>
                <th className='px-5 py-3.5 text-left font-mono text-[12px] font-semibold tracking-wide text-[#f5a623] uppercase'>
                  아케이드
            ...
            <tbody>
              {COMPARE_ROWS.map((row, i) => (
                ...
                >
                  <td className='px-5 py-3 font-medium break-keep text-white/55'>
                    {row.label}
                  </td>
                  <td className='px-5 py-3 font-semibold break-keep text-white/90'>
                    {row.console}
                  </td>
                  <td className='px-5 py-3 font-semibold break-keep text-white/90'>
                    {row.arcade}
