...
export function ScheduleEventCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex w-20 flex-col items-center justify-center border-r px-2 py-6 text-center',
      ...
      <div className='flex min-w-0 flex-1 items-start justify-between gap-3 px-4 py-6'>
